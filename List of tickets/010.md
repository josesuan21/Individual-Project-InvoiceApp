...
Notes acts as an additional information if the user wants to give a comment about the services being done.
...
| Size | Engineering notes | 
| -------- | -------- |
|  1  | Adding a simple if statements and inserting data using simple INSERT sql commands | 
